...
struct Component {
  ...
  bool operator<(const Component &rhs) const { return _dist < rhs._dist; }
...
int main(int argc, char **argv) {
  ...
  read_contours_ser(o.data_dir + "/" + o.fn, back_inserter(contours),
                    back_inserter(exceptions), o.slice, o.slice, -1,
  ...
  cout << "./ContourTilerBin -e 1e-15 -C 0.01 -d output -o raw -z 0.05 -n "
          "data -s "
       << o.slice << " " << o.slice + 1 << " ";
  cout << "-c " << o.component << " ";
