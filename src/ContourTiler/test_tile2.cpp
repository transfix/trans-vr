...
string tile_test(File_iter files_begin, File_iter files_end, double z_scale = 1)
{
...
//   TW_handle tw = tile(slices[0].begin(), slices[0].end(), slices[1].begin(), slices[1].end(), options);
