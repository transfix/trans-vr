...
Refer to the attached reame file for a further explanation into this
algorithm.*/
...
void set_index_and_time(int ax, int ay, int az, unsigned char index,
  ...
  /******************************************************************************
  theta and phi are the spherical angles corresponding to the voxel
  (cx,cy,cz).*/
  ...
  for (n = 1; n < 5; n++) {
    ...
    previously set then we set the seed_index and the tdata.*/
...
tree. We then remove this point and adjust the rest of the tree accordingly.
