...
void QGLViewer::setDefaultShortcuts()
{
	...
	// 9-6-2011, arand: changed the "quit program" shortcut
	//                  because I kept hitting escape to close
	//                  a dialog or something and accidentally 
...
#else 
	    QMessageBox::warning(this, tr("Stereo not supported", "Message box window title"), tr("Stereo is not included in this build. Please rebuild the application with stereo support."));
#endif
	  }
	  else
	    stereo_ = false;
