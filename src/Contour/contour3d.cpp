...
int Contour3d::AddVert(float x, float y, float z, float nx, float ny, float nz, float f)
{
	int n = nvert++;
	if(nvert > vsize)
	{
...
int Contour3d::AddVertUnique(float x, float y, float z, float nx, float ny, float nz, float f)
{
#ifdef USEDICT
