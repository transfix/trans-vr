...
int main(int argc, char **argv)
{
  if(argc < 8)
    {
      cerr << "Usage: inputfile, bb_xdim1, bb_xdim2, bb_ydim1, bb_ydim2, bb_zdim1, bb_zdim2"<<" \n"
	   <<"The program gives the mean voxel value and the standard deviation, sigma, of voxels"<<" \n"
