...
int main(int argc, char **argv) {
  ...
  cvcapp.log(1, "cvc.volumes = " + cvcstate("cvc.volumes").value() + "\n");
  ...
  cvcapp.log(1, "cvc parentName = " + cvcstate("cvc").parentName() + "\n");
  cvcapp.log(1, "root parentName = " + cvcstate().parentName() + "\n");
