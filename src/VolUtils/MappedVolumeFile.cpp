...
/* $Id: MappedVolumeFile.cpp 4742 2011-10-21 22:09:44Z transfix $ */
			 ...
			 unsigned char *buf)
{
  ...
  tmp_buf = (lfmap_ptr_t)malloc(dimx*dimy*dimz*variableTypeSizes[m_VariableType]);
