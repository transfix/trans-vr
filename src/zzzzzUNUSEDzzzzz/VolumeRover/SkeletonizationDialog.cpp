...
/* $Id: SkeletonizationDialog.cpp 3500 2011-01-25 16:51:16Z arand $ */

#include <qlineedit.h>
#include <qvalidator.h>
#include <VolumeRover/SkeletonizationDialog.h>

SkeletonizationDialog::SkeletonizationDialog( QWidget* parent,  const char* name, bool modal, Qt::WFlags fl )
    : SkeletonizationDialogBase( parent, name, modal, fl )
{
  ...
  m_PlCnt->setValidator(new QIntValidator(this));
  m_Theta->setValidator(new QDoubleValidator(this));
  m_MedialRatio->setValidator(new QDoubleValidator(this));
}
