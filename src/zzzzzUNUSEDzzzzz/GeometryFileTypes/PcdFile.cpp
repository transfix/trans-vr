...
/* $Id: PcdFile.cpp 1787 2010-06-01 18:51:21Z transfix $ */
...
PcdFile PcdFile::ms_PcdFileRepresentative;
...
bool PcdFile::checkType(const string& fileName)
{
	bool zeroSeen = false, maxSeen = false;
	float f1,f2,f3;
...
bool PcdFile::saveFile(const Geometry* geometry, const string& fileName)
{
...
GeometryFileType* PcdFile::getRepresentative()
{
	return &ms_PcdFileRepresentative;
}
