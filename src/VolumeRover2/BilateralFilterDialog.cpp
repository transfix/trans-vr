...
BilateralFilterDialog::~BilateralFilterDialog() { delete _ui; }

void BilateralFilterDialog::OutputFileSlot() {
  _ui->OutputFilename->setText(
      QFileDialog::getSaveFileName(this, "Results File"));
}
...
public:
  BilateralFilterThread(double radSig, double spatSig, double filRad,
                        ...
                        const std::string &output, const std::string &dataset,
                        int currentIndex, const std::string &fileType)
      : _radSig(radSig), _spatSig(spatSig), _filRad(filRad),
...
void BilateralFilterDialog::RunBilateralFilter() {
  ...
  cvcapp.startThread("bilateral_filter_thread_" + volSelected,
                     BilateralFilterThread(
                         radSig, spatSig, filRad, volSelected, output,
