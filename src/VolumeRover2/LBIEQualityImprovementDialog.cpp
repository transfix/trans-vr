...
LBIEQualityImprovementDialog::~LBIEQualityImprovementDialog() { delete _ui; }
/*
...
public:
  ...
  void operator()() {
    ...
    cvcraw_geometry::cvcgeom_t geom =
        boost::any_cast<cvcraw_geometry::cvcgeom_t>(
...
void LBIEQualityImprovementDialog::RunLBIEQualityImprovement() {
  ...
  cvcapp.startThread(
      "lbie_quality_thread",
      LBIEQualityImprovementThread(iterations, geomSelected, output));
}
