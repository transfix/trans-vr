...
VolumeMemoryInterface::VolumeMemoryInterface(const VolMagick::Volume &vol,
  ...
  QGridLayout *volumeInterfaceViewerLayout =
      new QGridLayout(_ui->_volumeInterfaceViewer);
  _volumeInterfaceViewer =
      new CVC_NAMESPACE::VolumeViewer(_ui->_volumeInterfaceViewer);
...
void VolumeMemoryInterface::setViewerState() {
  ...
  properties["volumeInterfaceViewer.volume_rendering_quality"] =
      "0.5"; //[0.0,1.0]
