...
// Functions to handle the degeneracy and potential problem in voronoi computation
// These next functions are used to get the voronoi point if points are coplanar.
// Coplanarity makes CGAL very sad. :-(
