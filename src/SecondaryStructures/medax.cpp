...
bool is_VF_on_boundary_of_medax(const Triangulation& triang,
								const Edge& e)
{
...
void detect_axis_candidates(Triangulation& triang, const double theta, const double ratio)
{
...
// Using the conditions, compute a medial axis which is homotopy equivalent to the surface.
...
void mark_connected_medial_axis_comp(Triangulation& triang, int& biggest_medax_comp_id)
{
...
void compute_medial_axis(Triangulation& triang,	const double theta, const double medial_ratio, int& biggest_medax_comp_id)
{
