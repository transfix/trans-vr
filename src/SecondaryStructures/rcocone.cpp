...
// Initializes the attributes associated with the voronoi and delaunay simplices
...
void mark_big_tetrahedral_balls(Triangulation& triang, const double& bb_ratio)
{
...
void identify_deep_intersection(Triangulation& triang, const double theta_ff, const double theta_if)
{
...
// Write the points in the outside tetrahedron. These will be input to tight cocone.
