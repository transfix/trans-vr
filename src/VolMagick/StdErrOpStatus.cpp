...
namespace VolMagick {
void StdErrOpStatus::start(const VolMagick::Voxels *, Operation,
                           VolMagick::uint64 numSteps) const {
  _numSteps = numSteps;
}

void StdErrOpStatus::step(const VolMagick::Voxels *, Operation op,
...
void StdErrOpStatus::end(const VolMagick::Voxels *, Operation) const {
  fprintf(stderr, "\n");
}
} // namespace VolMagick
