 ...
 *
 *  $Id: islice.c 1478 2010-03-07 22:58:12Z transfix $
 *  Log at end
 */
...
int sliceGetXSize(Islice *slice) { return (slice->xsize); }

/*! Returns the Y size of [slice] */
int sliceGetYSize(Islice *slice) { return (slice->ysize); }
 ...
 * mode [mode]: simply the value for one-channel data, the amplitude of
 * complex data, or a weighted value for RGB data.
 */
