...
HistogramData::HistogramData(const std::vector<double> &inputPoints,
...
void HistogramData::save() {
  ...
  outfile << _initialized << "\t" << _inputMin << "\t" << _inputMax << "\t"
          << _binWidth << "\t";
...
void HistogramData::load() {
  ...
  infile >> _initialized >> _inputMin >> _inputMax >> _binWidth;
