...
// --------------------------
// is_VF_crossing_surface
// --------------------------
// Given a triangulation with surface triangles marked
// check if a VF crosses the surface
// --------------------------
...
// mark_VF_on_u1
// --------------
// Mark the VF to be on um_i1 for some i1.
// ---------------------------
...
// mark_VF_visited
// --------------
// Mark the VF dual to e(DE) visited.
// ---------------------------
void mark_VF_visited(Triangulation &triang, Cell_handle &c, int uid,
                     int vid) {
  Facet_circulator fcirc = triang.incident_facets(Edge(c, uid, vid));
  Facet_circulator begin = fcirc;
