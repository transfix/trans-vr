...
int scale_shift(double xshift, double yshift, VertType *lines_ary0,
                ...
                short **new_group_ary1, short *new_group_ind_ary1,
                int group_num1) {
  ...
  find_bounding_box(box1, lines_ary0, new_group_ary0, new_group_ind_ary0,
                    group_num0);

  find_bounding_box(box2, lines_ary1, new_group_ary1, new_group_ind_ary1,
                    group_num1);
