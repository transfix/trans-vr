...
*/
    ...
    */	
	...
	push_boundary_array(Optimum_tiling_mode&1, group0,ind0,2,group1,ind1); /* left boundary */
    push_boundary_array(Optimum_tiling_mode&1, group0,new_ind0,1,group1,new_ind1); /* right boundary */
}
...
*/
    ...
    */	
    ...
    if(cnt==2)
	{
		push_boundary_array(Optimum_tiling_mode&1, group0,ind0,1,group1,ind1);
		...
		{ 
			...
			push_boundary_array(Optimum_tiling_mode&1,group0,new_ind0,2,group1,ind1);
		...
		else 
		{
			...
			push_boundary_array(Optimum_tiling_mode&1,group0,ind0,2,group1,new_ind1);
...
*/
    ...
    */	
    ...
    if(cnt==2)
	{
		push_boundary_array(Optimum_tiling_mode&1,group0,ind0,2,group1,ind1);
		...
		else 
		{
			...
			push_boundary_array(Optimum_tiling_mode&1,group0,ind0,1,group1,new_ind1);
					   ...
					   short group_num0, short * group_tab1, short group_num1)
{
  ...
  for(seq=0; seq<loop; seq++)
  {
    ...
    if(!is_break) push_boundary_array(Optimum_tiling_mode&1, group0,ind0,tile_dir,group1,ind1);
    ...
    */
    ...
    if(legal1)
	{
		...
		if(is_top) {
			top_best_tiling_tab[ind0].used=1; /* used */
			push_boundary_array(Optimum_tiling_mode&1,
			group0,new_ind0,1,group1,ind1); /* right boundary */
		}
		else  
		{
			bot_best_tiling_tab[ind1].used=1; /* used */
			push_boundary_array(Optimum_tiling_mode&1,
			group0,ind0,1,group1,new_ind1); /* right boundary */
		}
    }
    else if(legal2)
	{
		push_boundary_array(Optimum_tiling_mode&1,group0,new_ind0,1,group1,new_ind1); /* left boundary */
		if(is_top) 
		{
			bot_best_tiling_tab[ind1].used=1; /* used */
			push_boundary_array(Optimum_tiling_mode&1,group0,new_ind0,2,group1,ind1); /* right boundary */
		}
		else
		{
			top_best_tiling_tab[ind0].used=1; /* used */
			push_boundary_array(Optimum_tiling_mode&1,group0,ind0,2,group1,new_ind1); /* right boundary */
		}
    }
}
