...
void do_best_tiling(int group0, int group1, int ind0, int ind1,
  ...
  */
  ...
  push_boundary_array(Optimum_tiling_mode & 1, group0, ind0, 2, group1,
                      ind1); /* left boundary */
  push_boundary_array(Optimum_tiling_mode & 1, group0, new_ind0, 1, group1,
                      new_ind1); /* right boundary */
}
...
void do_overlapping_pt_tiling(int group0, int group1, int ind0, int ind1,
  ...
  */
  ...
  if (cnt == 2) {
    push_boundary_array(Optimum_tiling_mode & 1, group0, ind0, 1, group1,
                        ind1);
    ...
    if (dist[0] < dist[1]) {
      ...
      push_boundary_array(Optimum_tiling_mode & 1, group0, new_ind0, 2,
                          group1, ind1);
  ...
  */
  ...
  if (cnt == 2) {
    ...
    if (dist[0] < dist[1]) { /* choose the upper triangle */
      ...
      push_boundary_array(Optimum_tiling_mode & 1, group0, new_ind0, 1,
                          group1, ind1);
...
void do_partial_tiling(int group0, int group1, int ind0, int ind1,
  ...
  */
  ...
  for (seq = 0; seq < loop; seq++) {
    ...
    if (!is_break)
      push_boundary_array(Optimum_tiling_mode & 1, group0, ind0, tile_dir,
                          group1, ind1);
