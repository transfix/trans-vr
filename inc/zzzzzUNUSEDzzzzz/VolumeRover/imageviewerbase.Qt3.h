...
public:
    ...
    void setupUi(Q3MainWindow *ImageViewerBase)
    {
        if (ImageViewerBase->objectName().isEmpty())
            ImageViewerBase->setObjectName(QString::fromUtf8("ImageViewerBase"));
        ImageViewerBase->resize(600, 480);
        SaveAsAction = new QAction(ImageViewerBase);
        SaveAsAction->setObjectName(QString::fromUtf8("SaveAsAction"));
        SaveAsAction->setName("SaveAsAction");
        SaveAsAction->setEnabled(false);
        widget = new QWidget(ImageViewerBase);
        ...
        m_PixmapLabel = new QLabel(widget);
        m_PixmapLabel->setObjectName(QString::fromUtf8("m_PixmapLabel"));
        m_PixmapLabel->setPixmap(qt_get_icon(image0_ID));
        m_PixmapLabel->setScaledContents(true);
        m_PixmapLabel->setWordWrap(false);

        vboxLayout->addWidget(m_PixmapLabel);

        ImageViewerBase->setCentralWidget(widget);
        menubar = new QMenuBar(ImageViewerBase);
        ...
        retranslateUi(ImageViewerBase);
        QObject::connect(SaveAsAction, SIGNAL(activated()), ImageViewerBase, SLOT(saveAsSlot()));

        QMetaObject::connectSlotsByName(ImageViewerBase);
    } // setupUi

    void retranslateUi(Q3MainWindow *ImageViewerBase)
    {
        ImageViewerBase->setWindowTitle(QApplication::translate("ImageViewerBase", "Image Viewer", 0, QApplication::UnicodeUTF8));
        SaveAsAction->setIconText(QApplication::translate("ImageViewerBase", "Save &As...", 0, QApplication::UnicodeUTF8));
        SaveAsAction->setText(QApplication::translate("ImageViewerBase", "Save &As...", 0, QApplication::UnicodeUTF8));
        PopupMenu->setTitle(QApplication::translate("ImageViewerBase", "&File", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
...
namespace Ui {
    class ImageViewerBase: public Ui_ImageViewerBase {};
} // namespace Ui

QT_END_NAMESPACE

class ImageViewerBase : public Q3MainWindow, public Ui::ImageViewerBase
{
    Q_OBJECT

public:
    ImageViewerBase(QWidget* parent = 0, const char* name = 0, Qt::WindowFlags fl = Qt::WType_TopLevel);
    ~ImageViewerBase();
