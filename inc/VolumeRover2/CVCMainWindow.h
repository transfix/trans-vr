...
public:
  RemoteSegThread(Ui::SegmentVirusMapDialog *dialog, CVCMainWindow *cvcmw,
...
public:
  LocalSegThread(std::string filename, Ui::SegmentVirusMapDialog *dialog,
                 CVCMainWindow *cvcmw, unsigned int stackSize = 0);
  ~LocalSegThread() {}
...
public:
  ...
  template <class T> void insertDataWidget(QWidget *w) {
...
protected:
  CVCMainWindow(QWidget *parent = nullptr,
