...
void generateOctree(sweetMesh::hexMesh &octreeMesh, double step,
                    VolMagick::Volume &vol, double isoval);
bool testOctreeHex(double x, double y, double z, double step, double isoval,
...
double getOctree(VolMagick::Volume &vol, sweetMesh::hexMesh &octreeMesh,
                 double isoval);
