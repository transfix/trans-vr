...
int check_bounding_boxes_intersection(VertType *, VertType *, VertType *,
                                      VertType *, int);

int find_intersection(VertType *, VertType *, VertType *, VertType *,
                      VertType *t, double *, double *);

int solve_2_equations(double, double, double, double, double, double,
                      double *, double *);

int find_intersection_3D(VertType *, VertType *, VertType *, VertType *,
                         VertType *, double *);

int is_inside_contour(VertType *, VertType *, short *, short, double *,
                      int *);
