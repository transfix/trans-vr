 ...
 *
 *  $Id: mrcfiles.h 1478 2010-03-07 22:58:12Z transfix $
 *  Log at end
 */
...
#include <VolMagick/libiimod/hvemtypes.h>
...
int mrcReadZByte(MrcHeader *hdata, struct LoadInfo *li, unsigned char *buf,
                 int z);
int mrcReadYByte(MrcHeader *hdata, struct LoadInfo *li, unsigned char *buf,
                 int y);
int mrcReadZ(MrcHeader *hdata, struct LoadInfo *li, unsigned char *buf,
             int cz);
int mrcReadY(MrcHeader *hdata, struct LoadInfo *li, unsigned char *buf,
             int cy);
int mrcReadSection(MrcHeader *hdata, struct LoadInfo *li, unsigned char *buf,
                   int z);
