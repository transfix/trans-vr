...
public:
  ...
  /*
    in_vox - input voxels
    in_i,j,k - input indices specifying the current input voxel being
    composited this_vox - the destination voxels object where the result of
    the composition will be stored this_i,j,k - the destination voxel indices
    returns - the result of the composition
  */
  virtual double operator()(const Voxels &in_vox, uint64 in_i, uint64 in_j,
                            uint64 in_k, const Voxels &this_vox,
                            uint64 this_i, uint64 this_j,
