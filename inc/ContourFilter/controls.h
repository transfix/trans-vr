...
public:
  ...
  void setReturnRawContourPoints       (int   value) { RETURN_RAW_CONTOUR_POINTS = value; }
  void setReturnInterpolatedRawPoints  (int   value) { RETURN_INTERPOLATED_RAW_POINTS = value; }
  void setPtPerContourThreshold        (int   value) { MIN_PT_PER_CONTOUR_THRESHOLD = value; }
  void setNumMovesPerIteration         (int   value) { SIM_ANNEAL_MOVES_PER_ITERATION = value; }
  void setMaxNumMoveAttempts           (int   value) { SIM_ANNEAL_MAX_NUM_MOVE_ATTEMPTS = value; }
  void setIntegrationStep              (int   value) { SIM_ANNEAL_INTEGRATION_STEP = value; }
  void setMaxDeviationAdjustments      (int   value) { MAX_DEVIATION_ADJUSTMENTS = value; }
  void setCurvatureEnergyExponent      (int   value) { SIM_ANNEAL_CURVATURE_ENERGY_EXPONENT = value; }
  void setProximityEnergyExponent      (int   value) { SIM_ANNEAL_PROXIMITY_ENERGY_EXPONENT = value; }
  void setAdditionalPointsFactor       (double value) { ADDITIONAL_POINTS_FACTOR = value; }
  void setIntegrationStepFactor        (double value) { SIM_ANNEAL_INTEGRATION_STEP_FACTOR = value; }
  ...
  void setCurvatureEnergyGain          (double value) { SIM_ANNEAL_CURVATURE_ENERGY_GAIN = value; }
  void setProximityEnergyGain          (double value) { SIM_ANNEAL_PROXIMITY_ENERGY_GAIN = value; }
  void setMeanAmplitudeNoise           (double value) { SIM_ANNEAL_MEAN_AMPLITUDE_NOISE = value; }
  void setMaxRadiusOfCurvature         (double value) { MAXIMUM_RADIUS_OF_CURVATURE = value; }
  ...
  void addIgnoredContour         (char const *value) { IGNORED_CONTOURS.push_back(value); }
  void addUsedContour            (const std::string& value) { USED_CONTOURS.push_back(value); }
...
public:
  ...
  bool contourIsIgnored (char const * const name) const
  {
    ...
    {
      for (std::vector<std::string>::const_iterator i=USED_CONTOURS.begin();i!=USED_CONTOURS.end();i++)
      {
	if (sname == *i) return false;
