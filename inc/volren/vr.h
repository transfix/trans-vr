...
typedef struct {
  ...
  unsigned int
      g_var; /* variable number of the variable interpreted as green */
  unsigned int
      b_var; /* variable number of the variable interpreted as blue */
  unsigned int
      den_var; /* variable number of the variable interpreted as density */
...
typedef enum { GRAY_SCALE = 0, RGB = 1 } ColorMode;
...
typedef struct {
  ...
  unsigned int
      vol_size;         /* Size of the entire volume = dim[0]*dim[1]*dim[2] */
  ...
  Point3d minb,
      maxb; /* left and right corners of the subvolume bounding box */
...
typedef struct {
  ...
  int pix_width,
      pix_height; /* Height & Width of pixels in the rendered image */
  float pix_sz_x,
      pix_sz_y; /* pixel size: pix_sz_x = win_width / pix_width ... */
} Viewing;
 ...
 */
typedef struct {
  int n_material; /* number of material types in the ray_casting rendering
                     mode */
...
typedef struct {
  ...
  Volume *metavol; /* A volume that contains all the volumes.  This volume
                      does not have it's own density values */
  int n_env;
} MultiVolRenEnv;

/**
 * Create a default volume rendering environment.
 * @note this function is not very useful; normally you should call
 * vrCreateEnvFromFile()
 */
 ...
 */
VolRenEnv *vrCreateEnvFromFile(char *fname, unsigned int slc_id,
                               unsigned int num_slc);
...
static float spec_val[QUANTIZE_SIZE + 1] = {
    ...
    0.0000000000f, 0.0000000000f, 0.0000000000f, 0.0000000000f, 0.0000000000f,
    0.0000000000f, 0.0000000000f, 0.0000000000f, 0.0000000000f, 0.0000000000f,
    0.0000000000f, 0.0000000000f, 0.0000000000f, 0.0000000000f, 0.0000000001f,
    0.0000000001f, 0.0000000001f, 0.0000000002f, 0.0000000002f, 0.0000000003f,
    0.0000000005f, 0.0000000007f, 0.0000000009f, 0.0000000013f, 0.0000000017f,
    0.0000000023f, 0.0000000030f, 0.0000000040f, 0.0000000052f, 0.0000000067f,
    0.0000000087f, 0.0000000111f, 0.0000000141f, 0.0000000179f, 0.0000000225f,
    0.0000000282f, 0.0000000351f, 0.0000000435f, 0.0000000537f, 0.0000000660f,
    0.0000000808f, 0.0000000985f, 0.0000001196f, 0.0000001447f, 0.0000001744f,
    0.0000002095f, 0.0000002509f, 0.0000002995f, 0.0000003564f, 0.0000004228f,
    0.0000005002f, 0.0000005901f, 0.0000006943f, 0.0000008147f, 0.0000009537f,
    0.0000011136f, 0.0000012973f, 0.0000015078f, 0.0000017486f, 0.0000020234f,
    0.0000023366f, 0.0000026927f, 0.0000030969f, 0.0000035549f, 0.0000040730f,
    0.0000046581f, 0.0000053179f, 0.0000060605f, 0.0000068952f, 0.0000078320f,
    0.0000088818f, 0.0000100566f, 0.0000113694f, 0.0000128346f, 0.0000144675f,
    0.0000162851f, 0.0000183056f, 0.0000205491f, 0.0000230371f, 0.0000257929f,
    0.0000288420f, 0.0000322117f, 0.0000359318f, 0.0000400341f, 0.0000445532f,
    0.0000495264f, 0.0000549937f, 0.0000609983f, 0.0000675867f, 0.0000748087f,
    0.0000827181f, 0.0000913722f, 0.0001008329f, 0.0001111662f, 0.0001224429f,
    0.0001347390f, 0.0001481355f, 0.0001627189f, 0.0001785821f, 0.0001958237f,
    0.0002145493f, 0.0002348714f, 0.0002569098f, 0.0002807920f, 0.0003066542f,
    0.0003346407f, 0.0003649054f, 0.0003976115f, 0.0004329327f, 0.0004710532f,
    0.0005121685f, 0.0005564857f, 0.0006042250f, 0.0006556189f, 0.0007109142f,
    0.0007703720f, 0.0008342684f, 0.0009028956f, 0.0009765625f, 0.0010555953f,
    0.0011403387f, 0.0012311566f, 0.0013284330f, 0.0014325730f, 0.0015440037f,
    0.0016631753f, 0.0017905623f, 0.0019266641f, 0.0020720069f, 0.0022271443f,
    0.0023926585f, 0.0025691618f, 0.0027572985f, 0.0029577450f, 0.0031712120f,
    0.0033984459f, 0.0036402307f, 0.0038973885f, 0.0041707819f, 0.0044613164f,
    0.0047699404f, 0.0050976477f, 0.0054454808f, 0.0058145304f, 0.0062059397f,
    0.0066209044f, 0.0070606768f, 0.0075265658f, 0.0080199419f, 0.0085422369f,
    0.0090949470f, 0.0096796378f, 0.0102979429f, 0.0109515702f, 0.0116423015f,
    0.0123719964f, 0.0131425979f, 0.0139561314f, 0.0148147102f, 0.0157205369f,
    0.0166759100f, 0.0176832248f, 0.0187449735f, 0.0198637564f, 0.0210422818f,
    0.0222833678f, 0.0235899501f, 0.0249650832f, 0.0264119450f, 0.0279338416f,
    0.0295342132f, 0.0312166363f, 0.0329848267f, 0.0348426551f, 0.0367941335f,
    0.0388434343f, 0.0409948975f, 0.0432530195f, 0.0456224754f, 0.0481081195f,
    0.0507149920f, 0.0534483157f, 0.0563135147f, 0.0593162142f, 0.0624622516f,
    0.0657576770f, 0.0692087561f, 0.0728220046f, 0.0766041428f, 0.0805621594f,
    0.0847032964f, 0.0890350342f, 0.0935651362f, 0.0983016342f, 0.1032528430f,
    0.1084273756f, 0.1138341427f, 0.1194823608f, 0.1253815740f, 0.1315416247f,
    0.1379727423f, 0.1446854621f, 0.1516907066f, 0.1589997262f, 0.1666242033f,
    0.1745761633f, 0.1828680634f, 0.1915127486f, 0.2005234957f, 0.2099140435f,
    0.2196985334f, 0.2298915833f, 0.2405083179f, 0.2515642941f, 0.2630755901f,
    0.2750587761f, 0.2875310481f, 0.3005099893f, 0.3140138686f, 0.3280614316f,
    0.3426720798f, 0.3578657508f, 0.3736630976f, 0.3900852799f, 0.4071542025f,
    0.4248923957f, 0.4433231056f, 0.4624702632f, 0.4823584855f, 0.5030131936f,
    0.5244604945f, 0.5467272997f, 0.5698413849f, 0.5938313007f, 0.6187263727f,
    0.6445568204f, 0.6713537574f, 0.6991492510f, 0.7279761434f, 0.7578684092f,
    0.7888609171f, 0.8209894300f, 0.8542908430f, 0.8888031244f, 0.9245651364f,
    0.9616170526f, 1.0000000000f};
 ...
 * Set Volume layout
 */
void vrSetVolumeInfo(Volume *vol, char *fname, char *type, float span[3],
                     int dim[3]);
 ...
 */
int vrAddMaterial(Rendering *rend, Volume *vol, Shading *shade, float opac,
                  int start, int up, int down, int end);
...
int vrSetColDenRamp(Rendering *rend, int id, int den, int r, int g, int b,
                    int a);
 ...
 * @return 1 if successful, 0 otherwise
 */
int vrAddIsoSurface(Rendering *rend, Shading *shade, float opac,
                    float isoval);

int vrSetIsoSurface(Rendering *rend, int id, Shading *shade, float opac,
                    float isoval);
 ...
 * @return 1 if successful, 0 otherwise
 */
int vrAddLight(Rendering *rend, int r, int g, int b, float x, float y,
               float z);

int vrSetLight(Rendering *rend, int id, int r, int g, int b, float x, float y,
               float z);
 ...
 */
void vrCalcIntersectTx(Point3d *ray_org, Vector3d *dir, float px,
                       Point3d *pnt);

void vrCalcIntersectTy(Point3d *ray_org, Vector3d *dir, float py,
                       Point3d *pnt);

void vrCalcIntersectTz(Point3d *ray_org, Vector3d *dir, float pz,
                       Point3d *pnt);
 ...
 */
void vrGetDenNorm(VolRenEnv *env, float pnt[3], int idx[3], float *den,
                  Vector3d *norm, unsigned char *flag, float vals[8]);
 ...
 */
void vrComputeColorOpacity(VolRenEnv *env, float pnt[3], int idx[3],
                           float den, Vector3d *norm, float vals[8],
 ...
 */
void vrComputeColorOpacitySurf(VolRenEnv *env, float pnt[3], int idx[3],
                               int n, iRay *ray, Cell *cell, float vals[8],
                               float color[3], float *opac);

/**
 * Compute color with Phong shading.
 */
void vrPhongShading(VolRenEnv *env, float color[3], Shading *shade,
                    Vector3d *norm);
 ...
 */
void vrRawVGetVertColor(Volume *vol, int timestep, int idx[3],
                        float color[3][8]);
