 ...
 *
 * <pre>
 * 176 [main] INFO  org.apache.log4j.examples.Sort - Populating an array of 2
 * elements in reverse order. 225 [main] INFO
 * org.apache.log4j.examples.SortAlgo - Entered the sort method. 262 [main]
 * DEBUG org.apache.log4j.examples.SortAlgo.OUTER i=1 - Outer loop. 276 [main]
 * DEBUG org.apache.log4j.examples.SortAlgo.SWAP i=1 j=0 - Swapping
 * intArray[0] = 1 and intArray[1] = 0 290 [main] DEBUG
 * org.apache.log4j.examples.SortAlgo.OUTER i=0 - Outer loop. 304 [main] INFO
 * org.apache.log4j.examples.SortAlgo.DUMP - Dump of interger array: 317
 * [main] INFO  org.apache.log4j.examples.SortAlgo.DUMP - Element [0] = 0 331
 * [main] INFO  org.apache.log4j.examples.SortAlgo.DUMP - Element [1] = 1 343
 * [main] INFO  org.apache.log4j.examples.Sort - The next log statement should
 * be an error message. 346 [main] ERROR
 * org.apache.log4j.examples.SortAlgo.DUMP - Tried to dump an uninitialized
 * array. 467 [main] INFO  org.apache.log4j.examples.Sort - Exiting main
 * method.
 * </pre>
 *
 ...
 *   specifier</em> enclosed between braces. For example,
 * <b>%%d{%%H:%%M:%%s}</b> or
 * <b>%%d{%%d&nbsp;%%b&nbsp;%%Y&nbsp;%%H:%%M:%%s}</b>.  If no date format
 *   specifier is given then
 * <b>%%d{%%d&nbsp;%%m&nbsp;%%Y&nbsp;%%H:%%M:%%s}</b> is assumed.
 *
 ...
 *   <li>%%Q -- fractional milliseconds as decimal(0-999.999) -- <b>Log4CPLUS
 * specific</b> <li>%%S -- Second as decimal(0-59)</li> <li>%%U -- Week of
 * year, Sunday being first day(0-53)</li> <li>%%w -- Weekday as a
 * decimal(0-6, Sunday being 0)</li> <li>%%W -- Week of year, Monday being
 * first day(0-53)</li> <li>%%x -- Standard date string</li> <li>%%X --
 * Standard time string</li> <li>%%y -- Year in decimal without
 * century(0-99)</li> <li>%%Y -- Year including century as decimal</li>
