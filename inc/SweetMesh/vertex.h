...
public:
  ...
  void setX(double theValue) { x = theValue; }
  void setY(double theValue) { y = theValue; }
  void setZ(double theValue) { z = theValue; }
  ...
  double euclidianNorm() const { return sqrt(x * x + y * y + z * z); }
  void print() const {
...
inline double det(const vertex &v0, const vertex &v1, const vertex &v2) {
  return v0.X() * v1.Y() * v2.Z() + v1.X() * v2.Y() * v0.Z() +
         v2.X() * v0.Y() * v1.Z() - v0.X() * v2.Y() * v1.Z() -
         v1.X() * v0.Y() * v2.Z() - v2.X() * v1.Y() * v0.Z();
}
...
public:
  ...
  unsigned int OrderIndex() const { return orderIndex; }
  void setOrderIndex(unsigned int i) { orderIndex = i; }
  void OrderIndex(unsigned int i) { orderIndex = i; }
};
...
public:
  ...
  quadVertex() {}
  quadVertex(double X, double Y, double Z) {
    x = X;
    y = Y;
    z = Z;
  }
...
public:
  ...
  hexVertex();
  hexVertex(const vertex &op, bool boundaryBool,
            unsigned int readOrderIndex = 0);
  hexVertex(double newX, double newY, double newZ, bool boundaryBool = false,
            unsigned int readOrderIndex = 0);
  ~hexVertex() {}
