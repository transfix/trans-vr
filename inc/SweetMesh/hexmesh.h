...
public:
  ...
  std::list<hexahedron>::iterator addHex(hexVertex &V0, hexVertex &V1,
                                         hexVertex &V2, hexVertex &V3,
                                         hexVertex &V4, hexVertex &V5,
                                         hexVertex &V6, hexVertex &V7,
                                         unsigned int orderIndex = 0);
  std::list<hexahedron>::iterator
  removeHex(std::list<hexahedron>::iterator &deleteHexItr);
  void clear();
...
protected:
  ...
  void addEdge(std::list<hexVertex>::iterator &vertexA_Itr,
  ...
  void addQuad(std::list<hexVertex>::iterator &vertexA_Itr,
               std::list<hexVertex>::iterator &vertexB_Itr,
