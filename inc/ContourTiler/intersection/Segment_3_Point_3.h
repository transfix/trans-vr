...
template <class R>
inline bool do_intersect(const CGAL::Segment_3<R> &s,
                         const CGAL::Point_3<R> &p) {
  return s.has_on(p);
}

template <class R>
inline CGAL::Object intersection(const CGAL::Segment_3<R> &s,
                                 const CGAL::Point_3<R> &p) {
...
template <class R>
inline bool collinear(const CGAL::Segment_3<R> &s,
                      const CGAL::Point_3<R> &p) {
