...
void read_polygons_gnuplot2(std::istream& in, OutputIterator polygons, Number_type z)
{
...
template <typename OutputIterator>
void read_polygons_gnuplot2(const std::string& filename, OutputIterator polygons, Number_type z)
{
...
template <typename OutputIterator>
void read_contours_gnuplot2(std::istream& in, OutputIterator contours, Number_type z)
{
...
template <typename OutputIterator>
void read_contours_gnuplot2(const std::string& filename, OutputIterator contours, Number_type z)
{
  std::ifstream in(filename.c_str());
...
template <typename OutputIterator>
void read_polygons_gnuplot3(const std::string& filename, OutputIterator polygons)
{
  std::ifstream in(filename.c_str());
