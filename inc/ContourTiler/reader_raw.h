...
void read_triangles_raw(std::istream& in, OutputIterator triangles, bool color)
{
...
template <typename OutputIterator>
void read_triangles_raw(const std::string& filename, OutputIterator triangles, bool color)
{
