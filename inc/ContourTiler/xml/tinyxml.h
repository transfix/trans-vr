...
/**
   ...
   sibilings</b> will be Visited.
        ...
        All flavors of Visit methods have a default implementation that
   returns 'true' (continue visiting). You need to only override methods that
...
/** TiXmlBase is a base class for every class in TinyXml.
        ...
        An Element can contain:	Element (container or leaf)
                                                        Text	(leaf)
                                                        Attributes (not on
   tree) Comment (leaf) Unknown (leaf)
...
/** XML text. A text node can have 2 ways to output the next. "normal" output
   ...
   and you generally want to leave it alone, but you can change the output
   mode with SetCDATA() and query it with CDATA().
*/
...
/**
   ...
   this is an incredibly useful thing. Note that TiXmlHandle is not part of
   the TinyXml DOM structure. It is a separate utility class.
        ...
        Assuming you want the value of "attributeB" in the 2nd "Child"
   element, it's very easy to write a *lot* of code that looks like:
   ...
   "Element" ).Child( "Child", 1 ).ToElement(); if ( child2 )
        ...
        It is also safe to copy handles - internally they are nothing more
   than node pointers.
        @verbatim
   ...
   Child method is a linear walk to find the element, so this code would
   iterate much more than it needs to. Instead, prefer:
...
/** Print to memory functionality. The TiXmlPrinter is useful when you need
   ...
   mode. Before calling Accept() you can call methods to control the printing
