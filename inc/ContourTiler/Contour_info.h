...
// Contour_info class
//--------------------------------------------------------
template <typename Slice_t = Number_type> class Contour_info {
public:
  typedef Slice_t Slice_type;

public:
  Contour_info() : _slice(0), _name(""), _object_name("") {}
  Contour_info(Slice_t slice, const std::string &name,
               const std::string &object_name)
      : _slice(slice), _name(name), _object_name(object_name) {}
  //   Contour_info(SurfRecon::CurvePtr cp) : _slice((int)cp->get<0>()),
  //   _name(cp->get<3>()), _object_name(cp->get<3>()) {}
  ~Contour_info() {}
...
std::ostream &operator<<(std::ostream &out,
                         const Contour_info<Slice_t> &info) {
...
template <typename Slice_t>
bool operator==(const Contour_info<Slice_t> &a,
                const Contour_info<Slice_t> &b) {
