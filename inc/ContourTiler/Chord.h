...
//   {
//     return _vertices[0] == chord._vertices[0] && _vertices[1] == chord._vertices[1];
//   }
...
//       throw new std::logic_error("The two vertices on a tile must lie on different contours");
//     // This restriction is so that the hashing function is consistent
//     if (v0.contour()->slice() > v1.contour()->slice())
//       throw new std::logic_error("The first vertex must be on a lower slice than the second vertex");
