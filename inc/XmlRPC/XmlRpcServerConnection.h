...
public:
  ...
  //! Constructor
  XmlRpcServerConnection(int fd, XmlRpcServer *server,
  ...
  //!   @param eventType Type of IO event that occurred. @see
...
protected:
  ...
  bool executeMethod(const std::string &methodName, XmlRpcValue &params,
                     XmlRpcValue &result);

  // Execute multiple calls and return the results in an array.
  bool executeMulticall(const std::string &methodName, XmlRpcValue &params,
                        XmlRpcValue &result);
