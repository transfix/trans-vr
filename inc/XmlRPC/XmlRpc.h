...
public:
  ...
  //! Returns the level of verbosity of informational messages. 0 is no
  //! output, 5 is very verbose.
  static int getVerbosity() { return _verbosity; }

  //! Specify the level of verbosity of informational messages. 0 is no
  //! output, 5 is very verbose.
...
//! Returns log message verbosity. This is short for
//! XmlRpcLogHandler::getVerbosity()
int getVerbosity();
//! Sets log message verbosity. This is short for
