...
namespace CVCColorTable
{
   ...
   Q_OBJECT
   public:
       ConSpecInfoNode(int id, double position, float isoval, float area, float minvol, float maxvol, float grad, int nComp);
       ConSpecInfoNode(const ConSpecInfoNode& copy);
       virtual ~ConSpecInfoNode();

       void updateNode(double position, float isoval, float area, float minvol, float maxvol, float grad, int nComp);
   ...
   public:
    ...
    void updateInfo(int id, double position, float isoval, float area, float minvol, float maxvol, float grad, int nComp);
    void remove(int id);
