...
protected:
  ...
  ///\fn void drawControlBarVertical( QPainter* painter, QRect rect, double
  ///doublePos ) \brief Draws a control bar in a vertical orientation \param
  ///painter A QPainter object to use for drawing \param rect The bounding
  ///rectangle \param doublePos A position along the widget
  void drawControlBarVertical(QPainter *painter, QRect rect,
                              double doublePos);
  ...
  ///\fn void drawControlBarHorizontal( QPainter* painter, QRect rect, double
  ///doublePos ) \brief Draws a control bar in a horizontal orientation \param
  ///painter A QPainter object to use for drawing \param rect The bounding
  ///rectangle \param doublePos A position along the widget
  void drawControlBarHorizontal(QPainter *painter, QRect rect,
                                double doublePos);
