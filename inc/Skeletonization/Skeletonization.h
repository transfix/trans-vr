...
namespace Skeletonization
{
  ...
  public:
	...
	{}
      ...
      Parameters& threshold(double t) { _threshold = t; return *this; }
      int pl_cnt() const { return _pl_cnt; }
      Parameters& pl_cnt(int p) { _pl_cnt = p; return *this; }
      bool discard_by_threshold() const { return _discard_by_threshold; }
      Parameters& discard_by_threshold(bool d) { _discard_by_threshold = d; return *this; }
