...
class cThinning {
	...
	public:
		void ConnectedComponents(char *OutFileName, _DataType MatMin, _DataType MatMax);
		void ConnectedComponents2(char *OutFileName, _DataType MatMin, _DataType MatMax);
		void Thinning4Subfields(char *OutFileName, _DataType MatMin, _DataType MatMax);
		void Skeletonize(char *OutFileName, _DataType MatMin, _DataType MatMax);

	private:
		void Reduce_ORTH_DIAG_Nonend_Voxels(int Px, int Py, int Pz, int& NumRepeat_Ret);
		int	Is_DiametricallyAdjacent(int Xi, int Yi, int Zi, unsigned char *Cube_uc);
		...
		void Remove_All_Weakly_End_Voxels(int Px, int Py, int Pz, int& NumRepeat_Ret);
	...
	public:
		void SaveThreeColorVolume(char *OutFileName, _DataType MatMin, _DataType MatMax);
		void SaveThreeColorVolume(char *OutFileName, _DataType MatMin, _DataType MatMax,
		...
		void SaveThickSkeletons(char *OutFileName, _DataType MatMin, _DataType MatMax);
