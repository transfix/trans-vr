...
#define ANISOTROPIC_DIFFUSION_FOR_SECONDD // for OCGS, PED, ClassOnly,
                                          // Evaluation
...
#define SAVE_VOLUME_Stuffed_Lungs    // VesselSeg.cpp	(It takes around 6
                                     // minutes)
// #define		SAVE_VOLUME_Data_Diffusion		// Control.cpp
// #define		SAVE_VOLUME_Gvec_Diffusion		// Control.cpp
...
// #define 			SAVE_SEED_PTS_LINES // Save seed pts of line
// structures #define			THINNING // #define
// MARCHING_CUBES_SECONDD

// #define			TF_GENERATION	// Distance-based TF
// Generation, TFGeneration.cpp #define
// SAVE_DISTANCE_GMHIT_RAWV #define
// SAVE_DISTANCE_GMHIT_RAWIV #define
// TF_GENERATION_COMPUTE_DOT_PRODUCT
...
// #define SAVE_ZERO_CROSSING_SECOND_DERIVATIVE // Save Only Zero 2nd
// Derivative Voxels #define SAVE_ZERO_CROSSING_VOLUME #define
// SAVE_THREE_COLOR_VOLUME // for thinning #define SAVE_SEED_PTS // Save seed
// pts with original images
