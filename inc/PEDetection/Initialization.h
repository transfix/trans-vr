...
private:
  ...
  void AddInitialValue(int xi, int yj, int zk, _DataType LocalMin,
                       _DataType LocalMax);
  void UpdateMinMaxInitialValue(int xi, int yj, int zk, _DataType Min,
                                _DataType Max);
  void UpdateMinMaxInitialValue(int xi, int yj, int zk, _DataType Min,
  ...
  int FindMinMaxNeighbor(int xi, int yj, int zk, _DataType &Min,
                         _DataType &Max);
