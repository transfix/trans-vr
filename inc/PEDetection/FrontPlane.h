...
#define CLASS_NOT_CONNECTED	0x1000	// 0001 0000 0000 0000 N --> Does not connected to the heart
...
class cSkeletonVoxel {
	...
	public:
		...
		void getXYZ(int *XYZ3) { XYZ3[0] = Xi; XYZ3[1] = Yi; XYZ3[2] = Zi; };
...
class cSeedPtsInfo {
	...
	public:
		...
		int getNextNeighbors(int PrevSpID1, int PrevSpID2, cStack<int> &Neighbors_ret);
