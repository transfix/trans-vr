...
class cGVF
{
	...
	public:
		unsigned char* BoundaryMinMax(int NumSeedPts, int *Pts, _DataType &Min, _DataType &Max, _DataType &Ave);
		unsigned char* CWaterFlowMinMax(int NumSeedPts, int *Pts, _DataType &Min, _DataType &Max);
	...
	private:
		void QuickSortLocations(int *Locs, int NumLocs, char Axis1, char Axis2, char Axis3);
	...
	public:
		void SaveSeedPtImages(int *TempSeedPts, int NumSeedPts, _DataType Min, _DataType Max);
