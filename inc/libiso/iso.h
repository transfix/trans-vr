...
#endif
  /**
     iso_intersect : This fuction computes the intersection of ray and isosurface
     in a cell. Input is the ray, functions defined at the eight vertices of the
     cell and normals at these vertices. This function return 0 if the ray doesn't 
     intersect with the isosurface or the cell doesn't have isosurface of given value.
     It returns 1 and modifies the passed out intersection point and normal at that
     point using function parameters.
  */
