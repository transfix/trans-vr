...
void draw_VF(const SecondaryStructures::Triangulation &triang,
             const SecondaryStructures::Edge &dual_e, const double &r,
             const double &g, const double &b, const double &a,
             ofstream &fout);

void draw_tetra(const SecondaryStructures::Cell_handle &cell, const double &r,
                const double &g, const double &b, const double &a,
                ofstream &fout);
