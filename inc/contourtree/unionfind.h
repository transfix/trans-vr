...
public:
  ...
  void LowestVertex(int v, int vid) { LowestVtxArray[FindSet(v)] = vid; }

  int getLowestVertex(int v) { return LowestVtxArray[FindSet(v)]; }

  void HighestVertex(int v, int vid) { LowestVtxArray[FindSet(v)] = vid; }

  int getHighestVertex(int v) { return LowestVtxArray[FindSet(v)]; }
};
#endif
