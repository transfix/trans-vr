...
class Datavol : public Data
{
	...
	public : 	// get data or gradient approximations (by differencing)
		...
		virtual u_int   getNCellVerts(void)
		{
			return(4);
		}
		virtual u_int   getNCellFaces(void)
		{
			return(4);
		}
		virtual int   getCellAdj(int c, int f)
		{
			return(celladj[c][f]);
		}
...
// create a volume with the specified type and dimensions with data taken from the given file
