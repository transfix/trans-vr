...
public:
  ...
  typedef enum { UCHAR = 0, USHORT, FLOAT } DataType;
  ...
  // overloading
  virtual float *compFunction(int, u_int &, float ***, float ***,
                              float ***) = 0;
...
void Data::commonConstructor(DataType t, int _ndata, char *fn) {
...
#endif
  {
    ...
    char str[256];
    sprintf(str, "Data::commonConstructor: couldn't open file: %s", filename);
