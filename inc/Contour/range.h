...
*/
// range.h - class for performing range arithmetic.  A single range consists
// of
//           a sorted list of non-overlapping (min,max) pairs.  For
//           simplificity, we cap the number of pairs at 40.  This should be
//           dynamic, though for our usage ranges are not so fragmented.
