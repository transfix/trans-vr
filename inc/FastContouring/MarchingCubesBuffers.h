...
#if !defined(                                                                \
    AFX_MARCHINGCUBESBUFFERS_H__2F1981CF_3DB7_402D_B078_AB961D4B6189__INCLUDED_)
...
public:
  ...
  ///\brief Swaps edge buffers (There are two sets of vertices for each layer,
  ///one
  /// of them gets reused on the next layer of the volume. This function does
  /// the swapping for that)
  ...
  typedef boost::array<boost::shared_array<unsigned int>, 2>
      VertexClassificationsArray;
